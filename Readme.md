...
- Added LinkedIn profile link: `https://www.linkedin.com/in/tazegullu/`
- Updated hero positioning to Software Developer / C# .NET / Mobile Apps
...
- `styles.css` — full responsive dark app-portfolio design
- `script.js` — mobile navigation, reveal animation, active nav state, copy email
